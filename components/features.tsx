...
export default function Features() {
  const features = [
    ...
    },
    {
      ...
      description: "Receive tailored advice and insights based on your unique situation and personal journey.",
    },
    {
    ...
    },
    {
      ...
      description: "ThinkxLife learns and evolves with you, becoming more helpful with each conversation.",
    },
  ]

  return (
    <section id="features" className="py-24 px-6 md:px-12 lg:px-24 bg-slate-900/80">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-300 max-w-3xl mx-auto">
            Our AI companion is designed with your wellbeing in mind, offering support in multiple ways.
          </p>
        </div>
