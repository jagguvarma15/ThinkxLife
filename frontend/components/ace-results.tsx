...
export default function AceResults({ score, userName }: AceResultsProps) {
  ...
  if (chatStarted) {
    return (
      <ChatInterface
        initialMessage={getMessageBasedOnScore()}
      />
    )
  }
  ...
  return (
    <div className="bg-white rounded-xl p-8 shadow-xl">
      <h2 className="text-2xl font-bold text-center mb-6 text-gray-800">💬 Questionnaire Complete</h2>
      ...
      <div className="mb-8 p-6 bg-purple-50 rounded-lg border border-purple-100">
        ...
        <p className="text-gray-700">
          Thank you for sharing, {userName}. I'm here to listen and support you in a judgment-free space.
        </p>
      </div>

      <Button onClick={() => setChatStarted(true)} className="w-full bg-purple-700 hover:bg-purple-800 text-white py-3 text-lg">
        Start Chat with Zoe
      </Button>
    </div>
  )
