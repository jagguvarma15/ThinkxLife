    ...
    <footer className="bg-gray-100 text-gray-700">
      <div className="max-w-6xl mx-auto px-6 md:px-12 lg:px-24 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              <Link href="#" className="text-gray-500 hover:text-purple-700 transition-colors">
                <Facebook size={20} />
              </Link>
              <Link href="#" className="text-gray-500 hover:text-purple-700 transition-colors">
                <Twitter size={20} />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="https://thinkround.shop/" className="text-gray-600 hover:text-purple-700 transition-colors">
                  Shop Art
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                <Phone size={20} className="mr-2 text-purple-700 flex-shrink-0" />
                <span>(415) 602-9599</span>
              </li>
              <li className="flex items-center">
                <Mail size={20} className="mr-2 text-purple-700 flex-shrink-0" />
        ...
        <div className="border-t border-gray-200 pt-8 text-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} Think Round, Inc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
