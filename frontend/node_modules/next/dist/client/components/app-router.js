 ...
 */ function Router(param) {
   ...
   */ const appRouter = (0, _react.useMemo)(()=>{
        const routerInstance = {
            ...
            (href, options)=>(0, _segmentcache.prefetch)(href, actionQueue.state.nextUrl, actionQueue.state.tree, (options == null ? void 0 : options.kind) === _routerreducertypes.PrefetchKind.FULL) : (href, options)=>{
