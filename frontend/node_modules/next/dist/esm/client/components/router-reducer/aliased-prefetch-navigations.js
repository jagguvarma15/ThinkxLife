 ...
 */ export function handleAliasedPrefetchEntry(state, flightData, url, mutable) {
    ...
    for (const normalizedFlightData of flightData){
        ...
        if (isRootRender && seedData) {
            ...
            fillCacheWithNewSubTreeDataButOnlyLoading(newCache, currentCache, normalizedFlightData);
        }
