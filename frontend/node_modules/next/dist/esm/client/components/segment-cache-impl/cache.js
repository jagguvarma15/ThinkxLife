    ...
    if (seedDataChildren !== null) {
        for(const parallelRouteKey in seedDataChildren){
            ...
            if (childSeedData !== null) {
                ...
                writeSeedDataIntoCache(now, task, route, staleAt, childSeedData, encodeChildSegmentKey(key, parallelRouteKey, encodeSegment(childSegment)), entriesOwnedByCurrentTask);
            }
        }
    }
}
