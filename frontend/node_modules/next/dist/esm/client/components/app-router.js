 ...
 */ function Router(param) {
   ...
   */ const appRouter = useMemo(()=>{
        const routerInstance = {
            ...
            (href, options)=>prefetchWithSegmentCache(href, actionQueue.state.nextUrl, actionQueue.state.tree, (options == null ? void 0 : options.kind) === PrefetchKind.FULL) : (href, options)=>{
